    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>{{ _('Update Admin') }} <a href="{{route('admin.admins.index')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> {{ __('back') }} </a></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form method="post" action="{{ route('admin.admins.update', ['id' => $admin->id]) }}" data-parsley-validate class="form-horizontal form-label-left">
